...
{{
  ...
  "music_search_phrase": "cozy rain ambient",
...
- target_duration_seconds must be between 10 and 15 (prefer around 12; never exceed 20).
- Sum of duration_hint_seconds should approximately equal target_duration_seconds.
- Each duration_hint_seconds must be between 4 and 10.
- music_search_phrase must be 3–4 short English words suitable for Pixabay Music search
  (cozy ambient / rain / fireplace / forest / lofi study vibes). No brands or celebrity names.
